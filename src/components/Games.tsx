...
import { Sparkles, Users, Clock, Trophy, Search, Gamepad2, Dice5 } from 'lucide-react';
...
//       duration: '30 min',
//       difficulty: 'Easy',
// image: 'https://chatgpt.com/backend-api/estuary/content?id=file_00000000119c7209bee4f34968101696&ts=490743&p=fs&cid=1&sig=a88946c53ae3c2cd455b13b32c61ac81827846484ca0b0ca53a579150b4167fb&v=0&fit=crop&w=800&q=80', },
    {
      id: 3,
      name: 'Chess',
      category: 'board',
...
//       duration: '20 min',
//       difficulty: 'Easy',
//  image: 'https://images.unsplash.com/photo-1616628182506-1e7e54b02b89?auto=format&fit=crop&w=800&q=80',    },
    {
      id: 8,
      ...
      duration: '30-90 min',
      difficulty: 'Easy',
      image: 'https://images.unsplash.com/photo-1515569067071-ec3b51335dd0?w=400&h=300&fit=crop',
    },
      ...
      <section className="pt-32 pb-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto relative overflow-hidden">
        ...
        <div className="text-center mb-16 animate-slide-up">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary/10 border border-primary/20 mb-6">
            ...
            <span className="text-sm font-medium text-primary">Premium Game Collection</span>
          </div>
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto leading-relaxed">
            Discover an incredible collection of classic and modern games. From strategic challenges to party favorites, we have something for every gaming enthusiast.
          </p>
        </div>
              ...
              <div className="relative bg-card backdrop-blur-sm rounded-2xl overflow-hidden border border-border hover:border-primary/50 transition-all duration-500 hover:scale-105 hover:shadow-xl glow-subtle-hover">
                ...
                <div className="relative h-48 overflow-hidden">
                  ...
                  <div className={`absolute top-4 right-4 px-3 py-1 rounded-full text-xs font-semibold backdrop-blur-md ${
                    game.difficulty === 'Easy' ? 'bg-primary/20 text-primary border border-primary/30' :
                    game.difficulty === 'Medium' ? 'bg-accent/20 text-accent border border-accent/30' :
                ...
                <div className="relative p-6 space-y-4">
                  ...
                  <button onClick={()=>navigate('/book')} className="w-full py-3 bg-primary text-primary-foreground font-semibold rounded-xl opacity-0 group-hover:opacity-100 transform translate-y-2 group-hover:translate-y-0 transition-all duration-300 hover:shadow-lg glow-subtle">
                    Book Now
                  </button>
                </div>
        ...
        <div className="mt-24 relative">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              { icon: Trophy, label: 'Total Games', value: games.length, color: 'text-primary' },
              { icon: Users, label: 'Active Players', value: '100+', color: 'text-primary' },
              { icon: Sparkles, label: 'Events Monthly', value: '50+', color: 'text-primary' }
            ].map((stat, index) => (
              <div
                key={index}
